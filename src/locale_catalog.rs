...
pub(super) fn message_attribute(source: &str) -> Option<(&'static str, &'static str)> {
    match source {
        ...
        "Commit date" => Some(("ui", "commit-date")),
        ...
        "Custom paper size" => Some(("plot", "custom-paper-size")),
        "Printable margins" => Some(("plot", "printable-margins")),
        "Enter a positive width and height." => Some(("plot", "enter-a-positive-width-and-height")),
        "Paper size" => Some(("plot", "paper-size")),
        "{count} driver option(s) set for this printer." => Some(("plot", "count-driver-option-s-set-for-this-printer")),
        "Printer properties — {printer}" => Some(("plot", "printer-properties-printer")),
        ...
        "Mid Between 2 Points (M2P)" => Some(("common", "mid-between-2-points-m2p")),
        ...
        "MTP needs an active point prompt." => Some(("common", "mtp-needs-an-active-point-prompt")),
        ...
        "X (mm)" => Some(("plot", "x-mm")),
        "Select Drawing to Import Page Setups From" => Some(("plot", "select-drawing-to-import-page-setups-from")),
        "Drawings and templates" => Some(("plot", "drawings-and-templates")),
        "PSETUPIN: {count} page setup(s) imported, {replaced} replaced." => Some(("plot", "psetupin-count-page-setup-s-imported-replaced-replaced")),
        "PSETUPIN: {error}" => Some(("plot", "psetupin-error")),
        "PSETUPIN: no page setup named \"{want}\" in {file}." => Some(("plot", "psetupin-no-page-setup-named-want-in-file")),
        "PSETUPIN: nothing to import from {file}." => Some(("plot", "psetupin-nothing-to-import-from-file")),
        "No named page setups in this drawing." => Some(("plot", "no-named-page-setups-in-this-drawing")),
        "Import…" => Some(("plot", "import-ellipsis")),
        "Show the page setup for new layouts" => Some(("plot", "show-the-page-setup-for-new-layouts")),
        "X (in)" => Some(("plot", "x-in")),
        "Y (in)" => Some(("plot", "y-in")),
        "Hide paperspace objects" => Some(("plot", "hide-paperspace-objects")),
        "Save changes to layout" => Some(("plot", "save-changes-to-layout")),
        "{printer} does not support {sheet}; switched to its default sheet {default} (PAPERUPDATE = 1)." => Some(("plot", "printer-does-not-support-sheet-switched-to-its-default-sheet-default-paperupdate-1")),
        "{printer} does not support {sheet}; the sheet is kept (PAPERUPDATE = 0)." => Some(("plot", "printer-does-not-support-sheet-the-sheet-is-kept-paperupdate-0")),
        "{printer}: the printer reports no sheets; the paper catalogue is used." => Some(("plot", "printer-the-printer-reports-no-sheets-the-paper-catalogue-is-used")),
        "{printer}: {count} sheet(s) reported" => Some(("plot", "printer-count-sheet-s-reported")),
        "Default sheet: {sheet}" => Some(("plot", "default-sheet-sheet")),
        "Default sheet: not reported" => Some(("plot", "default-sheet-not-reported")),
        "Default printer: {name}" => Some(("plot", "default-printer-name")),
        "Default printer: none reported by the system" => Some(("plot", "default-printer-none-reported-by-the-system")),
        "Printers: none listed by the system" => Some(("plot", "printers-none-listed-by-the-system")),
        "Printers ({count}):" => Some(("plot", "printers-count")),
        "Could not list printers: {error}" => Some(("plot", "could-not-list-printers-error")),
        "Plots go through the PDF application: {command}" => Some(("plot", "plots-go-through-the-pdf-application-command")),
        "Plots go straight to the printer (no PDF application registers a print verb)." => Some(("plot", "plots-go-straight-to-the-printer-no-pdf-application-registers-a-print-verb")),
        "via the PDF application" => Some(("plot", "via-the-pdf-application")),
        "direct print" => Some(("plot", "direct-print")),
        ...
        "XREF: \"{}\" set to Overlay." => Some(("insert", "xref-set-to-overlay")),
        "XREF: bound \"{}\"." => Some(("insert", "xref-bound")),
        ...
        "Attach..." => Some(("insert", "xref-attach-menu")),
        "Change Path Type" => Some(("insert", "xref-change-path-type")),
        "Find and Replace..." => Some(("insert", "xref-find-and-replace-menu")),
        "Display Width" => Some(("insert", "xref-display-width")),
        "Display Height" => Some(("insert", "xref-display-height")),
        ...
        "Remove Path" => Some(("insert", "xref-remove-path")),
        "Select New Path" => Some(("insert", "xref-select-new-path")),
        "Select a single reference first." => Some(("insert", "xref-select-a-single-reference-first")),
        "Reload All References" => Some(("insert", "xref-reload-all-references")),
        "Opened" => Some(("insert", "xref-opened")),
        "Untitled" => Some(("insert", "xref-untitled")),
        "Unresolved" => Some(("insert", "xref-unresolved")),
        "Preview not available" => Some(("insert", "xref-preview-not-available")),
        "Reload All" => Some(("insert", "xref-reload-all")),
        "DWG" => Some(("insert", "xref-dwg")),
        "Pixel Width" => Some(("insert", "xref-pixel-width")),
        "Pixel Height" => Some(("insert", "xref-pixel-height")),
        "Resolution Unit" => Some(("insert", "xref-resolution-unit")),
        "XREF: cannot unload nested reference '{}'. Unload it in its host drawing." => Some(("insert", "xref-cannot-unload-nested-reference")),
        "XREF: cannot overlay nested reference '{}'. Overlay it in its host drawing." => Some(("insert", "xref-cannot-overlay-nested-reference")),
        "XREF: cannot reload nested reference '{}'. Reload it in its host drawing." => Some(("insert", "xref-cannot-reload-nested-reference")),
        "XREF: cannot attach nested reference '{}'. Attach it in its host drawing." => Some(("insert", "xref-cannot-attach-nested-reference")),
        "XREF: cannot set path type for nested reference '{}'. Set it in its host drawing." => Some(("insert", "xref-cannot-set-path-type-nested-reference")),
        "{}: reload applies to drawing references only." => Some(("insert", "reload-applies-to-drawing-references-only")),
        "XREF: \"{}\" set to Attach." => Some(("insert", "xref-set-to-attach")),
        "External References" => Some(("insert", "xref-manager-title")),
        "XATTACH: cannot attach the host drawing into itself." => Some(("insert", "xref-self-attach-blocked")),
        "XREF: cannot bind \"{}\": {}." => Some(("insert", "xref-cannot-bind")),
        "XREF: cannot detach nested reference '{}'. Detach it in its host drawing." => Some(("insert", "xref-cannot-detach-nested-reference")),
        "XREF: PDF bind (vector import) is not available in this version." => Some(("insert", "xref-pdf-bind-unavailable")),
        "XREF: cannot make path relative across drives." => Some(("insert", "xref-cannot-make-path-relative")),
        "XREF: detached \"{}\"." => Some(("insert", "xref-detached")),
        "XREF: no loaded reference with that key." => Some(("insert", "xref-no-loaded-reference-with-that-key")),
        "XREF: no references match '{}'." => Some(("insert", "xref-no-references-match")),
        "XREF: overlays apply to drawing references only." => Some(("insert", "xref-overlays-drawing-references-only")),
        "XREF: Path set for \"{}\" — Reload to apply." => Some(("insert", "xref-path-set-for")),
        "XREF: unloaded \"{}\"." => Some(("insert", "xref-unloaded")),
        "XREF: unknown option '{}'. Options: ? Reload Unload Detach Path Pathtype Bind Overlay Attach" => Some(("insert", "xref-unknown-option")),
        "XREF: updated {} reference(s)." => Some(("insert", "xref-updated-references")),
        "Usage: XREF Path <pattern> <new path>" => Some(("insert", "usage-xref-path-pattern")),
        "Usage: XREF Path Find <old> <new>" => Some(("insert", "usage-xref-path-find")),
        "Usage: XREF Pathtype <Full|Relative|None> [pattern]" => Some(("insert", "usage-xref-pathtype")),
        "{} reference(s) not found — open the reference manager with EXTERNALREFERENCES." => Some(("insert", "xref-missing-open-xrefman")),
        " (nested — not rendered)" => Some(("insert", "xref-nested-not-rendered")),
        "Change Path:" => Some(("insert", "change-path")),
        "Date" => Some(("insert", "date")),
        "Details" => Some(("insert", "details")),
        "Detach" => Some(("insert", "xref-detach")),
        "Failed" => Some(("insert", "failed")),
        "File attach is not available on web — the reference list below is read-only." => Some(("insert", "xref-file-attach-is-not-available-on-web")),
        "File name" => Some(("insert", "xref-file-name")),
        "Found At" => Some(("insert", "found-at")),
        "Help" => Some(("insert", "xref-help")),
        "Nested references are read-only — edit them in their host drawing." => Some(("insert", "xref-nested-references-are-read-only")),
        "Not found" => Some(("insert", "not-found")),
        "Orphaned" => Some(("insert", "orphaned")),
        "Overlay" => Some(("insert", "xref-overlay")),
        "Path:" => Some(("insert", "path")),
        "Reference Manager — select rows, then Detach, Unload, Reload, Bind, Overlay, or a Change Path mode." => Some(("insert", "xref-reference-manager-select-rows-bind")),
        "Bind" => Some(("insert", "xref-bind")),
        "Refresh" => Some(("insert", "xref-refresh")),
        "Relative" => Some(("insert", "relative")),
        "Reload" => Some(("insert", "xref-reload")),
        "Replace:" => Some(("insert", "xref-replace")),
        "Saved Path" => Some(("insert", "saved-path")),
        "Select a reference first." => Some(("insert", "xref-select-a-reference-first")),
        "Select a reference to inspect its details" => Some(("insert", "xref-select-a-reference-to-inspect-its")),
        "Set Path" => Some(("insert", "xref-set-path")),
        "Stale" => Some(("insert", "stale")),
        "Toggle list/tree" => Some(("insert", "toggle-list-tree")),
        "Tree" => Some(("insert", "tree")),
        "Type a new path first." => Some(("insert", "xref-type-a-new-path-first")),
        "Type the path prefix to find first." => Some(("insert", "xref-type-the-path-prefix-to-find-first")),
        "Unload" => Some(("insert", "xref-unload")),
        "Unloaded" => Some(("insert", "unloaded")),
        "new path for selection" => Some(("insert", "xref-new-path-for-selection")),
        "new path prefix" => Some(("insert", "xref-new-path-prefix")),
        "old path prefix" => Some(("insert", "xref-old-path-prefix")),
        "Y (mm)" => Some(("plot", "y-mm")),
        ...
        "Enter a valid cell range such as A1:D10." => Some(("common", "enter-a-valid-cell-range-such-as-a1-d10")),
        "Named ranges require a spreadsheet file." => Some(("common", "named-ranges-require-a-spreadsheet-file")),
        "Select a named range." => Some(("common", "select-a-named-range")),
        "The named range was not found." => Some(("common", "the-named-range-was-not-found")),
        "The named range does not refer to a worksheet cell range." => Some(("common", "the-named-range-does-not-refer-to-a-worksheet-cell-range")),
        "The spreadsheet contains no worksheets." => Some(("common", "the-spreadsheet-contains-no-worksheets")),
        "The selected data source is empty." => Some(("common", "the-selected-data-source-is-empty")),
        "The data link no longer exists." => Some(("common", "the-data-link-no-longer-exists")),
        "Writing to this data link is disabled." => Some(("common", "writing-to-this-data-link-is-disabled")),
        "Writing linked data is supported for CSV and text sources." => Some(("common", "writing-linked-data-is-supported-for-csv-and-text-sources")),
        "Data source not found: %{path}" => Some(("common", "data-source-not-found")),
        "Select at least one property." => Some(("common", "select-at-least-one-property")),
        "Select a data link." => Some(("common", "select-a-data-link")),
        "The selected data link no longer exists." => Some(("common", "the-selected-data-link-no-longer-exists")),
        "Columns, rows, width, and height must be positive values." => Some(("common", "columns-rows-width-and-height-must-be-positive-values")),
        "Choose a Spreadsheet File" => Some(("common", "choose-a-spreadsheet-file")),
        "Spreadsheet Files" => Some(("common", "spreadsheet-files")),
        "Enter a data link name." => Some(("common", "enter-a-data-link-name")),
        "A data link with that name already exists." => Some(("common", "a-data-link-with-that-name-already-exists")),
        "Data link deleted; existing table values were retained." => Some(("common", "data-link-deleted-existing-table-values-were-retained")),
        "No objects were selected when the wizard opened." => Some(("common", "no-objects-were-selected-when-the-wizard-opened")),
        "Add a drawing or include the current drawing." => Some(("common", "add-a-drawing-or-include-the-current-drawing")),
        "No extractable objects were found in the selected source." => Some(("common", "no-extractable-objects-were-found-in-the-selected-source")),
        "Select at least one object type." => Some(("common", "select-at-least-one-object-type")),
        "Choose at least one output." => Some(("common", "choose-at-least-one-output")),
        "Data Extraction Settings" => Some(("common", "data-extraction-settings")),
        "Add Drawings" => Some(("common", "add-drawings")),
        "CSV" => Some(("common", "csv")),
        ...
        "Applications" => Some(("common", "applications")),
        "Installed plugins and their sources" => Some(("common", "installed-plugins-and-their-sources")),
        "Plugins…" => Some(("common", "plugins-2")),
        "Keyboard shortcuts" => Some(("common", "keyboard-shortcuts-2")),
        "Keyboard Shortcuts…" => Some(("common", "keyboard-shortcuts-3")),
        "Command aliases" => Some(("common", "command-aliases-2")),
        "Command Aliases…" => Some(("common", "command-aliases-3")),
        "File Safety" => Some(("common", "file-safety")),
        "Automatic save" => Some(("common", "automatic-save")),
        "Minutes between recovery saves to a .sv$ file; 0 turns it off (SAVETIME)." => Some(("common", "minutes-between-recovery-saves-to-a-sv-file-0-turns-it-off-savetime")),
        "Keep a .bak copy when overwriting a drawing (ISAVEBAK)" => Some(("common", "keep-a-bak-copy-when-overwriting-a-drawing-isavebak")),
        "Plotting" => Some(("common", "plotting")),
        "Plot device, paper, scale and plot styles" => Some(("common", "plot-device-paper-scale-and-plot-styles")),
        "Plot and Page Setup…" => Some(("common", "plot-and-page-setup")),
        "Fill TrueType glyphs (TEXTFILL)" => Some(("common", "fill-truetype-glyphs-textfill")),
        "Command Line" => Some(("common", "command-line")),
        "Prompt lines" => Some(("common", "prompt-lines")),
        "Temporary prompt lines shown above the command window (CLIPROMPTLINES)." => Some(("common", "temporary-prompt-lines-shown-above-the-command-window-clipromptlines")),
        "History fade time" => Some(("common", "history-fade-time")),
        "How long overlay history lines stay visible; 0 skips them (COMMANDLINEFADETIME)." => Some(("common", "how-long-overlay-history-lines-stay-visible-0-skips-them-commandlinefadetime")),
        "Clicking overlapping objects opens a picker" => Some(("common", "clicking-overlapping-objects-opens-a-picker")),
        "Block Edit" => Some(("common", "block-edit")),
        "Double-click to edit block in-place (REFEDIT)" => Some(("common", "double-click-to-edit-block-in-place-refedit")),
        "Double-click attributed blocks to edit attributes (ATTEDIT)" => Some(("common", "double-click-attributed-blocks-to-edit-attributes-attedit")),
        ...
        "TEXTEDIT edits one object and ends (TEXTEDITMODE)" => Some(("common", "textedit-edits-one-object-and-ends-texteditmode")),
        "Continued dimensions inherit the base dimension's layer and style (DIMCONTINUEMODE)" => Some(("common", "continued-dimensions-inherit-the-base-dimension-s-layer-and-style-dimcontinuemode")),
        "QDIM origin priority" => Some(("common", "qdim-origin-priority")),
        "Which points QDIM measures from. Also settable inside the command." => Some(("common", "which-points-qdim-measures-from-also-settable-inside-the-command")),
        "Add scales automatically" => Some(("common", "add-scales-automatically")),
        "Which annotative objects pick up a newly set annotation scale (ANNOAUTOSCALE)." => Some(("common", "which-annotative-objects-pick-up-a-newly-set-annotation-scale-annoautoscale")),
        "Length, angle and insertion units" => Some(("common", "length-angle-and-insertion-units")),
        "Drawing Units…" => Some(("common", "drawing-units-2")),
        "Drafting" => Some(("common", "drafting")),
        "Drafting rotation" => Some(("common", "drafting-rotation")),
        "Rotates the crosshair and the snap grid in the active UCS (SNAPANG)." => Some(("common", "rotates-the-crosshair-and-the-snap-grid-in-the-active-ucs-snapang")),
        "Polar tracking increment" => Some(("common", "polar-tracking-increment")),
        "Snap and Grid" => Some(("common", "snap-and-grid")),
        "Snap modes, grid spacing and object snap" => Some(("common", "snap-modes-grid-spacing-and-object-snap")),
        "Drafting Settings…" => Some(("common", "drafting-settings-2")),
        "3D Modeling" => Some(("common", "modeling-3d")),
        "Display Tools" => Some(("common", "display-tools")),
        "Show the navigation cube (NAVVCUBE)" => Some(("common", "show-the-navigation-cube-navvcube")),
        "Show the UCS icon (UCSICON)" => Some(("common", "show-the-ucs-icon-ucsicon")),
        "Place the UCS icon at the origin (UCSICON ORigin)" => Some(("common", "place-the-ucs-icon-at-the-origin-ucsicon-origin")),
        "Display Resolution" => Some(("common", "display-resolution")),
        "applies to the current drawing" => Some(("common", "applies-to-the-current-drawing")),
        "Isolines per surface" => Some(("common", "isolines-per-surface")),
        "Show silhouette edges on solids (DISPSILH)" => Some(("common", "show-silhouette-edges-on-solids-dispsilh")),
        "Surface density U" => Some(("common", "surface-density-u")),
        "Surface density V" => Some(("common", "surface-density-v")),
        "Surface type" => Some(("common", "surface-type")),
        "Record the history of composite solids (SOLIDHIST)" => Some(("common", "record-the-history-of-composite-solids-solidhist")),
        "Show solid history" => Some(("common", "show-solid-history")),
        "Not available" => Some(("common", "not-available")),
        "Open folder" => Some(("common", "open-folder")),
        "Where the application keeps its own files. These locations are fixed." => Some(("common", "where-the-application-keeps-its-own-files-these-locations-are-fixed")),
        "Configuration" => Some(("common", "configuration")),
        "Plot styles" => Some(("common", "plot-styles")),
        "Autosave files" => Some(("common", "autosave-files")),
        ...
        "%{cmd}  Select objects or [Settings] (%{count} selected, Enter to apply):" => Some(("common", "select-objects-or-settings-selected-enter-to-apply")),
        "%{cmd}  Select objects or [Settings]:" => Some(("common", "select-objects-or-settings")),
        "+ Add parameter" => Some(("common", "add-parameter")),
        "3D Object Snap" => Some(("common", "object-snap-3d")),
        "3D Object Snap On (F4)" => Some(("common", "object-snap-on-f4-3d")),
        "3D Object Snap modes" => Some(("common", "object-snap-modes-3d")),
        "A numeric shell offset distance is required." => Some(("common", "a-numeric-shell-offset-distance-is-required")),
        "A selected edge no longer belongs to the body." => Some(("common", "a-selected-edge-no-longer-belongs-to-the-body")),
        "A selected face could not be resolved." => Some(("common", "a-selected-face-could-not-be-resolved")),
        "A selected face does not belong to the solid." => Some(("common", "a-selected-face-does-not-belong-to-the-solid")),
        "ALIGN  Scale objects based on alignment points? [Yes / No] <No>:" => Some(("common", "align-scale-objects-based-on-alignment-points-yes-no-no")),
        "ANNORESET: no selected object has alternate scale representations." => Some(("common", "annoreset-no-selected-object-has-alternate-scale-representations")),
        "ANNORESET: synchronized {} object(s) from the current scale." => Some(("common", "annoreset-synchronized-object-s-from-the-current-scale")),
        "Adaptive grid" => Some(("common", "adaptive-grid")),
        "Add Drawing Folder" => Some(("common", "add-drawing-folder")),
        "Add drawings…" => Some(("common", "add-drawings-2")),
        "Add folder…" => Some(("common", "add-folder")),
        "Add parameter" => Some(("common", "add-parameter-2")),
        "All other rows" => Some(("common", "all-other-rows")),
        "Allow selection cycling" => Some(("common", "allow-selection-cycling")),
        "Allow writing to source file" => Some(("common", "allow-writing-to-source-file")),
        "BREAK  Specify second break point or [First point]:" => Some(("common", "break-specify-second-break-point-or-first-point")),
        "Begin" => Some(("common", "begin")),
        "CHAMFEREDGE: select a base face edge." => Some(("common", "chamferedge-select-a-base-face-edge")),
        "Cannot delete beyond this." => Some(("common", "cannot-delete-beyond-this")),
        "Cell range" => Some(("common", "cell-range")),
        "Center of face" => Some(("common", "center-of-face")),
        "Choose output" => Some(("common", "choose-output")),
        "Clipboard access is unavailable. Press Ctrl+C or Command+C to copy the selected history." => Some(("common", "clipboard-access-is-unavailable-press-ctrl-c-or-command-c-to-copy-the-selected-history")),
        "Column & row settings" => Some(("common", "column-row-settings")),
        "Combine identical rows" => Some(("common", "combine-identical-rows")),
        "Constraint Settings" => Some(("common", "constraint-settings")),
        "Constraint Type" => Some(("common", "constraint-type")),
        "Copied" => Some(("common", "copied")),
        "Create a New Data Link" => Some(("common", "create-a-new-data-link")),
        "Create a new data extraction" => Some(("common", "create-a-new-data-extraction")),
        "Current drawing" => Some(("common", "current-drawing")),
        "Cursor-dependent position" => Some(("common", "cursor-dependent-position")),
        "DATAEXTRACTION  Specify insertion point:" => Some(("common", "dataextraction-specify-insertion-point")),
        "DATAEXTRACTION: external file created." => Some(("common", "dataextraction-external-file-created")),
        "DIMBREAK  Select dimension to add/remove break or [Multiple]:" => Some(("common", "dimbreak-select-dimension-to-add-remove-break-or-multiple")),
        "DIMBREAK  Select dimensions ({} selected, press Enter when done):" => Some(("common", "dimbreak-select-dimensions-selected-press-enter-when-done")),
        "DIMBREAK  Select object to break dimension or [Auto/Manual/Remove] <Auto>:" => Some(("common", "dimbreak-select-object-to-break-dimension-or-auto-manual-remove-auto")),
        "DIMBREAK  Specify first break point:" => Some(("common", "dimbreak-specify-first-break-point")),
        "DIMBREAK  Specify second break point:" => Some(("common", "dimbreak-specify-second-break-point")),
        "DIMBREAK: no editable dimensions were selected." => Some(("common", "dimbreak-no-editable-dimensions-were-selected")),
        "DIMBREAK: no intersections were found." => Some(("common", "dimbreak-no-intersections-were-found")),
        "DIMBREAK: removed breaks from {} dimension(s)." => Some(("common", "dimbreak-removed-breaks-from-dimension-s")),
        "DIMBREAK: select a dimension." => Some(("common", "dimbreak-select-a-dimension")),
        "DIMBREAK: updated {} dimension(s)." => Some(("common", "dimbreak-updated-dimension-s")),
        "DIMEDIT  Enter new dimension text <measured value>:" => Some(("common", "dimedit-enter-new-dimension-text-measured-value")),
        "DIMEDIT  Enter obliquing angle (press Enter for none):" => Some(("common", "dimedit-enter-obliquing-angle-press-enter-for-none")),
        "DIMEDIT  Enter type of dimension editing [Home/New/Rotate/Oblique] <Home>:" => Some(("common", "dimedit-enter-type-of-dimension-editing-home-new-rotate-oblique-home")),
        "DIMEDIT  Select objects:" => Some(("common", "dimedit-select-objects")),
        "DIMEDIT  Specify angle for dimension text:" => Some(("common", "dimedit-specify-angle-for-dimension-text")),
        "DIMEDIT: no editable dimensions were selected." => Some(("common", "dimedit-no-editable-dimensions-were-selected")),
        "DIMEDIT: updated {} dimension(s)." => Some(("common", "dimedit-updated-dimension-s")),
        "DIMJOGLINE  Select dimension to add jog or [Remove]:" => Some(("common", "dimjogline-select-dimension-to-add-jog-or-remove")),
        "DIMJOGLINE  Select dimension to remove jog:" => Some(("common", "dimjogline-select-dimension-to-remove-jog")),
        "DIMJOGLINE  Specify jog location (or press Enter):" => Some(("common", "dimjogline-specify-jog-location-or-press-enter")),
        "DIMJOGLINE: jog added." => Some(("common", "dimjogline-jog-added")),
        "DIMJOGLINE: jog removed." => Some(("common", "dimjogline-jog-removed")),
        "DIMJOGLINE: select a linear or aligned dimension." => Some(("common", "dimjogline-select-a-linear-or-aligned-dimension")),
        "DIMSPACE  Specify distance between dimensions or [Auto] <Auto>:" => Some(("common", "dimspace-specify-distance-between-dimensions-or-auto-auto")),
        "DIMSPACE: enter a non-negative spacing value or Auto." => Some(("common", "dimspace-enter-a-non-negative-spacing-value-or-auto")),
        "DIMSPACE: select a linear or aligned dimension." => Some(("common", "dimspace-select-a-linear-or-aligned-dimension")),
        "DIMSPACE: select one or more linear or aligned dimensions." => Some(("common", "dimspace-select-one-or-more-linear-or-aligned-dimensions")),
        "DIMSPACE: spacing value cannot be negative." => Some(("common", "dimspace-spacing-value-cannot-be-negative")),
        "DIMTEDIT  Specify angle for dimension text:" => Some(("common", "dimtedit-specify-angle-for-dimension-text")),
        "DIMTEDIT  Specify new location for dimension text or [Left/Right/Center/Home/Angle]:" => Some(("common", "dimtedit-specify-new-location-for-dimension-text-or-left-right-center-home-angle")),
        "DIMTEDIT: select a dimension." => Some(("common", "dimtedit-select-a-dimension")),
        "DIVIDE: {count} marker(s) placed." => Some(("common", "divide-marker-s-placed")),
        "DOF: {dof}" => Some(("common", "dof")),
        "DRAWORDER: selection reordered relative to reference objects." => Some(("common", "draworder-selection-reordered-relative-to-reference-objects")),
        "Data Extraction" => Some(("common", "data-extraction")),
        "Data Extraction Wizard" => Some(("common", "data-extraction-wizard")),
        "Data Link Manager" => Some(("common", "data-link-manager")),
        "Data extraction" => Some(("common", "data-extraction-2")),
        "Data link" => Some(("common", "data-link")),
        "Data link name" => Some(("common", "data-link-name")),
        "Data rows" => Some(("common", "data-rows")),
        "Define data source" => Some(("common", "define-data-source")),
        "Display Quick Properties palette on selection" => Some(("common", "display-quick-properties-palette-on-selection")),
        "Display Selection Cycling List Box" => Some(("common", "display-selection-cycling-list-box")),
        "Display coordinate input near crosshairs" => Some(("common", "display-coordinate-input-near-crosshairs")),
        "Display grid beyond Limits" => Some(("common", "display-grid-beyond-limits")),
        "Display selection candidate list box on click" => Some(("common", "display-selection-candidate-list-box-on-click")),
        "Distance and angle tolerances must be non-negative numbers." => Some(("common", "distance-and-angle-tolerances-must-be-non-negative-numbers")),
        "Distance1 = {:.4}, Distance2 = {:.4}" => Some(("common", "distance1-distance2")),
        "Draw section" => Some(("common", "draw-section")),
        "Drawing table" => Some(("common", "drawing-table")),
        "Drawings / folders" => Some(("common", "drawings-folders")),
        "Dynamic Prompts" => Some(("common", "dynamic-prompts")),
        "Edit an existing data extraction" => Some(("common", "edit-an-existing-data-extraction")),
        "Editing weighted or tolerance-fitted interpolation data is not supported." => Some(("common", "editing-weighted-or-tolerance-fitted-interpolation-data-is-not-supported")),
        "Empty table" => Some(("common", "empty-table")),
        "Enable Pointer Input (F12)" => Some(("common", "enable-pointer-input-f12")),
        "Enable dimension input fields" => Some(("common", "enable-dimension-input-fields")),
        "Enter a body editing option [Shell/eXit]:" => Some(("common", "enter-a-body-editing-option-shell-exit")),
        "Enter a solid editing option [Body/eXit]:" => Some(("common", "enter-a-solid-editing-option-body-exit")),
        "Entire sheet" => Some(("common", "entire-sheet")),
        "Equal X and Y spacing" => Some(("common", "equal-x-and-y-spacing")),
        "External file" => Some(("common", "external-file")),
        "Extraction settings" => Some(("common", "extraction-settings")),
        "FILLET  Select 2D polyline  [R={:.4}]:" => Some(("common", "fillet-select-2d-polyline-r")),
        "FILLET  Select first object or [Polyline/Radius]  [R={:.4}]:" => Some(("common", "fillet-select-first-object-or-polyline-radius-r")),
        "FILLET  Specify fillet radius or first point <{:.4}>:" => Some(("common", "fillet-specify-fillet-radius-or-first-point")),
        "FILLET  Specify second point for radius:" => Some(("common", "fillet-specify-second-point-for-radius")),
        "File" => Some(("common", "file")),
        "File not found — check the saved path." => Some(("common", "file-not-found-check-the-saved-path")),
        "First row" => Some(("common", "first-row")),
        "Fit data cannot be purged without a stored control curve." => Some(("common", "fit-data-cannot-be-purged-without-a-stored-control-curve")),
        "Fit data does not define a valid control curve." => Some(("common", "fit-data-does-not-define-a-valid-control-curve")),
        "Fit points do not define a valid spline." => Some(("common", "fit-points-do-not-define-a-valid-spline")),
        "Formula" => Some(("common", "formula")),
        "Full path" => Some(("common", "full-path")),
        "Fully constrained — no remaining degrees of freedom" => Some(("common", "fully-constrained-no-remaining-degrees-of-freedom")),
        "Grid On (F7)" => Some(("common", "grid-on-f7")),
        "Grid X spacing:" => Some(("common", "grid-x-spacing")),
        "Grid Y spacing:" => Some(("common", "grid-y-spacing")),
        "Grid behavior" => Some(("common", "grid-behavior")),
        "Grid spacing" => Some(("common", "grid-spacing")),
        "HATCHEDIT  Pattern:%{name}  Scale:%{scale}  Angle:%{angle}  [Style/Origin/Properties/COlor/LAyer/Transparency/DRaw order/ASsociate/DIsassociate/ANnotative/recreate Boundary/separate Hatches] <Properties>:" => Some(("common", "hatchedit-pattern-scale-angle-style-origin-properties-color-layer-transparency-draw-order-associate-disassociate-annotative-recreate-boundary-separate-hatches-properties")),
        "INTERSECT: created %{count} result object(s)." => Some(("common", "intersect-created-result-object-s")),
        "INTERSECT: no positive-area common result; %{count} original object(s) retained." => Some(("common", "intersect-no-positive-area-common-result-original-object-s-retained")),
        "INTERSECT: select at least two solids, Regions, or coplanar Surfaces of a compatible type." => Some(("common", "intersect-select-at-least-two-solids-regions-or-coplanar-surfaces-of-a-compatible-type")),
        "INTERSECT: the retained object could not be updated." => Some(("common", "intersect-the-retained-object-could-not-be-updated")),
        "INTERSECT: the selected coincident geometry is ambiguous." => Some(("common", "intersect-the-selected-coincident-geometry-is-ambiguous")),
        "INTERSECT: the selected objects do not have a supported coplanar surface intersection." => Some(("common", "intersect-the-selected-objects-do-not-have-a-supported-coplanar-surface-intersection")),
        "INTERSECT: the selected topology could not be intersected safely." => Some(("common", "intersect-the-selected-topology-could-not-be-intersected-safely")),
        "Include current drawing" => Some(("common", "include-current-drawing")),
        "Include subfolders" => Some(("common", "include-subfolders")),
        "Increment angle:" => Some(("common", "increment-angle")),
        "Indicator Fill Color" => Some(("common", "indicator-fill-color")),
        "Indicator Transparency" => Some(("common", "indicator-transparency")),
        "Insert Table" => Some(("common", "insert-table")),
        "Insert data extraction table into drawing" => Some(("common", "insert-data-extraction-table-into-drawing")),
        "Insert options" => Some(("common", "insert-options")),
        "Insert table after saving link" => Some(("common", "insert-table-after-saving-link")),
        "Insertion behavior" => Some(("common", "insertion-behavior")),
        "Keep table updated to source formatting" => Some(("common", "keep-table-updated-to-source-formatting")),
        "Knot" => Some(("common", "knot")),
        "LEADER  Enter an annotation option [None/Mtext]:" => Some(("common", "leader-enter-an-annotation-option-none-mtext")),
        "LEADER  Enter first line of annotation text or <options>:" => Some(("common", "leader-enter-first-line-of-annotation-text-or-options")),
        "LEADER  Enter leader formatting option [Spline/Straight/Arrow/None] <exit>:" => Some(("common", "leader-enter-leader-formatting-option-spline-straight-arrow-none-exit")),
        "LEADER  Enter next line of annotation text:" => Some(("common", "leader-enter-next-line-of-annotation-text")),
        "LEADER  Specify leader start point:" => Some(("common", "leader-specify-leader-start-point")),
        "LEADER  Specify next point or [Annotation/Format/Undo] <Annotation>:" => Some(("common", "leader-specify-next-point-or-annotation-format-undo-annotation")),
        "LEADER  Specify next point:" => Some(("common", "leader-specify-next-point")),
        "LENGTHEN  Select an object to change or [Undo]:" => Some(("common", "lengthen-select-an-object-to-change-or-undo")),
        "LENGTHEN  Select an object to measure or [Delta/Percent/Total/Dynamic]:" => Some(("common", "lengthen-select-an-object-to-measure-or-delta-percent-total-dynamic")),
        "LOFT  Enter an option [Guides/Path/Cross sections only/Settings/Continuity/Bulge magnitude] <Cross sections only>:" => Some(("common", "loft-enter-an-option-guides-path-cross-sections-only-settings-continuity-bulge-magnitude-cross-sections-only")),
        "LOFT  Enter an option [Guides/Path/Cross sections only/Settings] <Cross sections only>:" => Some(("common", "loft-enter-an-option-guides-path-cross-sections-only-settings-cross-sections-only")),
        "LOFT  Select cross-sections in order or [Point/Join/Mode] (Enter to finish)" => Some(("common", "loft-select-cross-sections-in-order-or-point-join-mode-enter-to-finish")),
        "Link option" => Some(("common", "link-option")),
        "Link settings" => Some(("common", "link-settings")),
        "Live Section Enabled" => Some(("common", "live-section-enabled")),
        "Ltype gen" => Some(("common", "ltype-gen")),
        "MEASURE: 0 markers placed." => Some(("common", "measure-0-markers-placed")),
        "MEASURE: {count} marker(s) placed." => Some(("common", "measure-marker-s-placed")),
        "Maintain associativity" => Some(("common", "maintain-associativity")),
        "Major line every:" => Some(("common", "major-line-every")),
        "Midpoint on edge" => Some(("common", "midpoint-on-edge")),
        "Moment of inertia" => Some(("common", "moment-of-inertia")),
        "More options" => Some(("common", "more-options")),
        "Move Down" => Some(("common", "move-down")),
        "Move Up" => Some(("common", "move-up")),
        "Named Parameters" => Some(("common", "named-parameters")),
        "Named range" => Some(("common", "named-range")),
        "Nearest to face" => Some(("common", "nearest-to-face")),
        "No path" => Some(("common", "no-path")),
        "No preview available." => Some(("common", "no-preview-available")),
        "No surfaces selected." => Some(("common", "no-surfaces-selected")),
        "OBJECTSCALE: the selected objects already have the current scale, or do not support annotation scales." => Some(("common", "objectscale-the-selected-objects-already-have-the-current-scale-or-do-not-support-annotation-scales")),
        "OBJECTSCALE: the selected objects do not have the current scale." => Some(("common", "objectscale-the-selected-objects-do-not-have-the-current-scale")),
        "OBJECTSCALE: {} the current scale on {} object(s)." => Some(("common", "objectscale-the-current-scale-on-object-s")),
        "Object Snap On (F3)" => Some(("common", "object-snap-on-f3")),
        "Object Snap Tracking On (F11)" => Some(("common", "object-snap-tracking-on-f11")),
        "Object Snap modes" => Some(("common", "object-snap-modes-2")),
        "On by default. Turn off to show just the constraint glyph in the viewport — enough to see that a constraint is present — without the driven value or named parameter text covering nearby geometry." => Some(("common", "on-by-default-turn-off-to-show-just-the-constraint-glyph-in-the-viewport-enough-to-see-that-a-constraint-is-present-without-the-driven-value-or-named-parameter-text-covering-nearby-geometry")),
        "One or more parametric constraints conflict or are redundant\nClick to remove one and re-solve" => Some(("common", "one-or-more-parametric-constraints-conflict-or-are-redundant-click-to-remove-one-and-re-solve")),
        "Ortho mode (F8)" => Some(("common", "ortho-mode-f8")),
        "Output data to external file" => Some(("common", "output-data-to-external-file")),
        "Output file" => Some(("common", "output-file")),
        "PEDIT  Convert lines and arcs to polylines [Yes/No] <Yes>:" => Some(("common", "pedit-convert-lines-and-arcs-to-polylines-yes-no-yes")),
        "PEDIT  Enter polyline linetype generation option [ON/OFF]:" => Some(("common", "pedit-enter-polyline-linetype-generation-option-on-off")),
        "PEDIT  Select polyline (or a line/arc to convert) or [Multiple]:" => Some(("common", "pedit-select-polyline-or-a-line-arc-to-convert-or-multiple")),
        "Palette Location" => Some(("common", "palette-location")),
        "Parameter '{}' already exists." => Some(("common", "parameter-already-exists")),
        "Parameter '{}': {}" => Some(("common", "parameter")),
        "Parameters" => Some(("common", "parameters")),
        "Perpendicular objects must share an intersection point" => Some(("common", "perpendicular-objects-must-share-an-intersection-point")),
        "Perpendicular to face" => Some(("common", "perpendicular-to-face")),
        "Plane" => Some(("common", "plane")),
        "Pointer Input" => Some(("common", "pointer-input")),
        "Polar Angle Settings" => Some(("common", "polar-angle-settings")),
        "Polar Tracking On (F10)" => Some(("common", "polar-tracking-on-f10")),
        "Polar Tracking guides cursor movement along specified angles. Ortho mode constrains movement to orthogonal axes." => Some(("common", "polar-tracking-guides-cursor-movement-along-specified-angles-ortho-mode-constrains-movement-to-orthogonal-axes")),
        "Press Enter to accept the chamfer or [Distance]:" => Some(("common", "press-enter-to-accept-the-chamfer-or-distance")),
        "Principal directions" => Some(("common", "principal-directions")),
        "Principal moments" => Some(("common", "principal-moments")),
        "Priority" => Some(("common", "priority")),
        "Product of inertia" => Some(("common", "product-of-inertia")),
        "REVERSE  Select line, polyline, spline or helix to reverse:" => Some(("common", "reverse-select-line-polyline-spline-or-helix-to-reverse")),
        "Radii of gyration" => Some(("common", "radii-of-gyration")),
        "Range" => Some(("common", "range")),
        "Recent Colors" => Some(("common", "recent-colors")),
        "Reference changes are not available on web — the reference list is read-only." => Some(("common", "reference-changes-are-not-available-on-web-the-reference-list-is-read-only")),
        "Refine data" => Some(("common", "refine-data")),
        "Relative path" => Some(("common", "relative-path")),
        "Remaining degrees of freedom in the current parametric constraint scope" => Some(("common", "remaining-degrees-of-freedom-in-the-current-parametric-constraint-scope")),
        "Requires an integer between 0 and 99." => Some(("common", "requires-an-integer-between-0-and-99")),
        "Requires numeric distance or two points." => Some(("common", "requires-numeric-distance-or-two-points")),
        "SECTIONPLANE  Align section to [Front/bAck/Top/Bottom/Left/Right] <Top>:" => Some(("common", "sectionplane-align-section-to-front-back-top-bottom-left-right-top")),
        "SECTIONPLANE  Enter section plane type [Plane/Slice/Boundary/Volume] <Plane>:" => Some(("common", "sectionplane-enter-section-plane-type-plane-slice-boundary-volume-plane")),
        "SECTIONPLANE  Specify next point or ENTER to complete:" => Some(("common", "sectionplane-specify-next-point-or-enter-to-complete")),
        "SECTIONPLANE  Specify next point:" => Some(("common", "sectionplane-specify-next-point")),
        "SECTIONPLANE  Specify point in direction of section view:" => Some(("common", "sectionplane-specify-point-in-direction-of-section-view")),
        "SECTIONPLANE  Specify start point:" => Some(("common", "sectionplane-specify-start-point")),
        "SECTIONPLANE  Specify through point:" => Some(("common", "sectionplane-specify-through-point")),
        "SETBYLAYER: no properties required changes." => Some(("common", "setbylayer-no-properties-required-changes")),
        "SETBYLAYER: reset {} entity/entities to ByLayer." => Some(("common", "setbylayer-reset-entity-entities-to-bylayer")),
        "SETVAR: CETRANSPARENCY LTSCALE CELTSCALE PDMODE PDSIZE TEXTSIZE ORTHOMODE FILLMODE MIRRTEXT FRAME IMAGEFRAME PDFFRAME WIPEOUTFRAME XCLIPFRAME POINTCLOUDCLIPFRAME ZOOMWHEEL ZOOMFACTOR SHORTCUTMENU SHORTCUTMENUDURATION CURSORSIZE PICKBOX CURSORTYPE SNAPANG TEXTFILL CLIPROMPTLINES COMMANDLINEFADETIME ATTREQ ATTDIA DIMASSOC DIMCONTINUEMODE CONSTRAINTSOLVEMODE CONSTRAINTINFER CONSTRAINTBARDISPLAY ANGBASE ANGDIR SKETCHINC SKPOLY SKTOLERANCE DONUTID DONUTOD CENTEREXE CENTERLAYER CENTERLTYPE CENTERLTSCALE CENTERLTYPEFILE CENTERCROSSSIZE CENTERCROSSGAP CENTERMARKEXE COLORTHEME SELECTIONAREA SELECTIONAREAOPACITY SELECTIONEFFECT SELECTIONEFFECTCOLOR WINDOWSAREACOLOR CROSSINGAREACOLOR SELECTIONPREVIEW GRIPSIZE GRIPCOLOR GRIPHOT GRIPHOVER GRIPOBJLIMIT | CLAYER CELTYPE TEXTSTYLE (read-only)" => Some(("common", "setvar-cetransparency-ltscale-celtscale-pdmode-pdsize-textsize-orthomode-fillmode-mirrtext-frame-imageframe-pdfframe-wipeoutframe-xclipframe-pointcloudclipframe-zoomwheel-zoomfactor-cursorsize-pickbox-cursortype-snapang-textfill-clipromptlines-commandlinefadetime-attreq-attdia-dimassoc-dimcontinuemode-constraintsolvemode-constraintinfer-constraintbardisplay-angbase-angdir-sketchinc-skpoly-sktolerance-donutid-donutod-centerexe-centerlayer-centerltype-centerltscale-centerltypefile-centercrosssize-centercrossgap-centermarkexe-colortheme-selectionarea-selectionareaopacity-selectioneffect-selectioneffectcolor-windowsareacolor-crossingareacolor-selectionpreview-gripsize-gripcolor-griphot-griphover-gripobjlimit-clayer-celtype-textstyle-read-only")),
        "SHELL supports rectangular boxes, circular cylinders, and spheres." => Some(("common", "shell-supports-rectangular-boxes-circular-cylinders-and-spheres")),
        "SHELL: solid updated." => Some(("common", "shell-solid-updated")),
        "SPLINEDIT  Fit data [Add/Delete/Move/Purge/Tangents/eXit] <eXit>:" => Some(("common", "splinedit-fit-data-add-delete-move-purge-tangents-exit-exit")),
        "SPLINEDIT  Fit data [Add/Delete/Move/Purge/eXit] <eXit>:" => Some(("common", "splinedit-fit-data-add-delete-move-purge-exit-exit")),
        "SPLINEDIT  Select any open curves to join to source:" => Some(("common", "splinedit-select-any-open-curves-to-join-to-source")),
        "SPLINEDIT  Specify a point on the spline <exit>:" => Some(("common", "splinedit-specify-a-point-on-the-spline-exit")),
        "SPLINEDIT  Specify control vertex to delete:" => Some(("common", "splinedit-specify-control-vertex-to-delete")),
        "SPLINEDIT  Specify control vertex:" => Some(("common", "splinedit-specify-control-vertex")),
        "SPLINEDIT  Specify end tangent or [System default]:" => Some(("common", "splinedit-specify-end-tangent-or-system-default")),
        "SPLINEDIT  Specify existing fit point on spline <exit>:" => Some(("common", "splinedit-specify-existing-fit-point-on-spline-exit")),
        "SPLINEDIT  Specify new fit point to add <exit>:" => Some(("common", "splinedit-specify-new-fit-point-to-add-exit")),
        "SPLINEDIT  Specify new location or [Next/Previous/Select point/eXit] <Next>:" => Some(("common", "splinedit-specify-new-location-or-next-previous-select-point-exit-next")),
        "SPLINEDIT  Specify new point or [After/Before] <exit>:" => Some(("common", "splinedit-specify-new-point-or-after-before-exit")),
        "SPLINEDIT  Specify precision 0-99 <10> (straight segments):" => Some(("common", "splinedit-specify-precision-0-99-10-straight-segments")),
        "SPLINEDIT  Specify start tangent or [System default]:" => Some(("common", "splinedit-specify-start-tangent-or-system-default")),
        "SPLINEDIT  [Add/Delete/Elevate order/Move/Weight/eXit] <eXit>:" => Some(("common", "splinedit-add-delete-elevate-order-move-weight-exit-exit")),
        "SPLINEDIT  [Close/Join/Move vertex/Refine/rEverse/convert to Polyline/Undo/eXit] <eXit>:" => Some(("common", "splinedit-close-join-move-vertex-refine-reverse-convert-to-polyline-undo-exit-exit")),
        "SPLINEDIT  [Fit data/Close/Join/Move vertex/Refine/rEverse/convert to Polyline/Undo/eXit] <eXit>:" => Some(("common", "splinedit-fit-data-close-join-move-vertex-refine-reverse-convert-to-polyline-undo-exit-exit")),
        "SPLINEDIT  [Fit data/Open/Move vertex/Refine/rEverse/convert to Polyline/Undo/eXit] <eXit>:" => Some(("common", "splinedit-fit-data-open-move-vertex-refine-reverse-convert-to-polyline-undo-exit-exit")),
        "SPLINEDIT  [Open/Move vertex/Refine/rEverse/convert to Polyline/Undo/eXit] <eXit>:" => Some(("common", "splinedit-open-move-vertex-refine-reverse-convert-to-polyline-undo-exit-exit")),
        "SUBTRACT  Convert selected closed Mesh objects to solids? [Yes/No] <Yes>:" => Some(("common", "subtract-convert-selected-closed-mesh-objects-to-solids-yes-no-yes")),
        "SUBTRACT  Select Solids, Regions, Surfaces, or Meshes to subtract, then press Enter:" => Some(("common", "subtract-select-solids-regions-surfaces-or-meshes-to-subtract-then-press-enter")),
        "SUBTRACT  Select base Solids, Regions, Surfaces, or Meshes, then press Enter:" => Some(("common", "subtract-select-base-solids-regions-surfaces-or-meshes-then-press-enter")),
        "SUBTRACT: a selected Mesh is not a supported closed single-shell mesh; no object was changed." => Some(("common", "subtract-a-selected-mesh-is-not-a-supported-closed-single-shell-mesh-no-object-was-changed")),
        "SUBTRACT: created %{count} result object(s)." => Some(("common", "subtract-created-result-object-s")),
        "SUBTRACT: no compatible base and cutter types or planes were selected." => Some(("common", "subtract-no-compatible-base-and-cutter-types-or-planes-were-selected")),
        "SUBTRACT: select at least one base and one cutter Solid, Region, or Surface." => Some(("common", "subtract-select-at-least-one-base-and-one-cutter-solid-region-or-surface")),
        "SUBTRACT: the retained base object could not be updated." => Some(("common", "subtract-the-retained-base-object-could-not-be-updated")),
        "SUBTRACT: the selected coincident geometry is ambiguous." => Some(("common", "subtract-the-selected-coincident-geometry-is-ambiguous")),
        "SUBTRACT: the selected geometry includes an unsupported surface intersection." => Some(("common", "subtract-the-selected-geometry-includes-an-unsupported-surface-intersection")),
        "SUBTRACT: the selected topology could not be cut safely." => Some(("common", "subtract-the-selected-topology-could-not-be-cut-safely")),
        "Second row" => Some(("common", "second-row")),
        "Section Plane" => Some(("common", "section-plane")),
        "Section Plane Offset" => Some(("common", "section-plane-offset")),
        "Select a 3D solid or surface edge." => Some(("common", "select-a-3d-solid-or-surface-edge")),
        "Select a 3D solid." => Some(("common", "select-a-3d-solid")),
        "Select a 3D solid:" => Some(("common", "select-a-3d-solid-2")),
        "Select a data link or create a new one." => Some(("common", "select-a-data-link-or-create-a-new-one")),
        "Select an edge or [Loop/Distance]:" => Some(("common", "select-an-edge-or-loop-distance")),
        "Select edge of loop or [Edge/Distance]:" => Some(("common", "select-edge-of-loop-or-edge-distance")),
        "Select face or any point to locate section line or [Draw section/Orthographic/Type]:" => Some(("common", "select-face-or-any-point-to-locate-section-line-or-draw-section-orthographic-type")),
        "Select faces to add [Undo/Remove/ALL] <done>:" => Some(("common", "select-faces-to-add-undo-remove-all-done")),
        "Select faces to remove [Undo/Add/ALL] <done>:" => Some(("common", "select-faces-to-remove-undo-add-all-done")),
        "Select objects in the current drawing" => Some(("common", "select-objects-in-the-current-drawing")),
        "Select properties" => Some(("common", "select-properties")),
        "Select spline-fit polylines:" => Some(("common", "select-spline-fit-polylines")),
        "Select surfaces to thicken:" => Some(("common", "select-surfaces-to-thicken")),
        "Selected objects in current drawing" => Some(("common", "selected-objects-in-current-drawing")),
        "Set cell styles" => Some(("common", "set-cell-styles")),
        "Sheet" => Some(("common", "sheet")),
        "Show associativity" => Some(("common", "show-associativity")),
        "Show command prompting and command input near crosshairs" => Some(("common", "show-command-prompting-and-command-input-near-crosshairs")),
        "Show count column" => Some(("common", "show-count-column")),
        "Show cycling badge when objects overlap" => Some(("common", "show-cycling-badge-when-objects-overlap")),
        "Show name column" => Some(("common", "show-name-column")),
        "Show values and parameter names on constraint markers" => Some(("common", "show-values-and-parameter-names-on-constraint-markers")),
        "Slice" => Some(("common", "slice")),
        "Slice Depth" => Some(("common", "slice-depth")),
        "Snap On (F9)" => Some(("common", "snap-on-f9")),
        "Snap X spacing:" => Some(("common", "snap-x-spacing")),
        "Snap Y spacing:" => Some(("common", "snap-y-spacing")),
        "Snap spacing" => Some(("common", "snap-spacing")),
        "Snap type" => Some(("common", "snap-type")),
        "Specify Distance1 or [Expression] <{:.4}>:" => Some(("common", "specify-distance1-or-expression")),
        "Specify Distance2 or [Expression] <{:.4}>:" => Some(("common", "specify-distance2-or-expression")),
        "Specify insertion point" => Some(("common", "specify-insertion-point")),
        "Specify point or enter arc length:" => Some(("common", "specify-point-or-enter-arc-length")),
        "Specify point or enter radius:" => Some(("common", "specify-point-or-enter-radius")),
        "Specify replacement path: XREF Path Find <old> <new>" => Some(("common", "specify-replacement-path-xref-path-find-old-new")),
        "Specify second point:" => Some(("common", "specify-second-point")),
        "Specify the shell offset distance <{:.3}>:" => Some(("common", "specify-the-shell-offset-distance")),
        "Specify thickness" => Some(("common", "specify-thickness")),
        "Specify window" => Some(("common", "specify-window")),
        "Spline cannot be converted within the requested precision." => Some(("common", "spline-cannot-be-converted-within-the-requested-precision")),
        "Spreadsheet Links" => Some(("common", "spreadsheet-links")),
        "Start from data extraction" => Some(("common", "start-from-data-extraction")),
        "Start from data link" => Some(("common", "start-from-data-link")),
        "Start from empty table" => Some(("common", "start-from-empty-table")),
        "State2" => Some(("common", "state2")),
        "Static quadrant location" => Some(("common", "static-quadrant-location")),
        "Status: Linked" => Some(("common", "status-linked")),
        "Status: Source not found" => Some(("common", "status-source-not-found")),
        "Surface Associativity" => Some(("common", "surface-associativity")),
        "Surface Type" => Some(("common", "surface-type-2")),
        "THICKEN: created {} solid(s); {} surface(s) could not be thickened exactly." => Some(("common", "thicken-created-solid-s-surface-s-could-not-be-thickened-exactly")),
        "Tab-separated text" => Some(("common", "tab-separated-text")),
        "Tangent objects must share an intersection point" => Some(("common", "tangent-objects-must-share-an-intersection-point")),
        "Tangent point must differ from the fit endpoint." => Some(("common", "tangent-point-must-differ-from-the-fit-endpoint")),
        "The INTERSECT result could not be displayed completely. The original objects were retained." => Some(("common", "the-intersect-result-could-not-be-displayed-completely-the-original-objects-were-retained")),
        "The INTERSECT result could not be encoded as ACIS." => Some(("common", "the-intersect-result-could-not-be-encoded-as-acis")),
        "The SUBTRACT result could not be displayed completely. The original objects were retained." => Some(("common", "the-subtract-result-could-not-be-displayed-completely-the-original-objects-were-retained")),
        "The SUBTRACT result could not be encoded as ACIS." => Some(("common", "the-subtract-result-could-not-be-encoded-as-acis")),
        "The UNION result could not be encoded as ACIS." => Some(("common", "the-union-result-could-not-be-encoded-as-acis")),
        "The chamfer history could not be recorded." => Some(("common", "the-chamfer-history-could-not-be-recorded")),
        "The edge body could not be updated." => Some(("common", "the-edge-body-could-not-be-updated")),
        "The edge body history could not be created." => Some(("common", "the-edge-body-history-could-not-be-created")),
        "The offset removes all material. Use a smaller distance or add a face back." => Some(("common", "the-offset-removes-all-material-use-a-smaller-distance-or-add-a-face-back")),
        "The region could not be encoded as ACIS." => Some(("common", "the-region-could-not-be-encoded-as-acis")),
        "The result could not be displayed completely. The original edge body was retained." => Some(("common", "the-result-could-not-be-displayed-completely-the-original-edge-body-was-retained")),
        "The selected base face no longer belongs to the body." => Some(("common", "the-selected-base-face-no-longer-belongs-to-the-body")),
        "The selected drawing data is ready to be extracted." => Some(("common", "the-selected-drawing-data-is-ready-to-be-extracted")),
        "The selected object is no longer available." => Some(("common", "the-selected-object-is-no-longer-available")),
        "The shell could not be constructed from the selected solid and distance." => Some(("common", "the-shell-could-not-be-constructed-from-the-selected-solid-and-distance")),
        "The shell offset distance must be nonzero." => Some(("common", "the-shell-offset-distance-must-be-nonzero")),
        "Trimmed surface" => Some(("common", "trimmed-surface")),
        "Trimming edges" => Some(("common", "trimming-edges")),
        "Trims" => Some(("common", "trims")),
        "Type a name and a formula (e.g. hole_dia = 12, hole_spacing = 2 * hole_dia + 1.5). Apply to save and re-solve; closing discards unapplied edits." => Some(("common", "type-a-name-and-a-formula-e-g-hole-dia-12-hole-spacing-2-hole-dia-1-5-apply-to-save-and-re-solve-closing-discards-unapplied-edits")),
        "U isolines" => Some(("common", "u-isolines-2")),
        "UNION: created %{count} result object(s)." => Some(("common", "union-created-result-object-s")),
        "UNION: select at least two solids, Regions, or planar Surfaces of the same type." => Some(("common", "union-select-at-least-two-solids-regions-or-planar-surfaces-of-the-same-type")),
        "UNION: the selected coincident geometry is ambiguous." => Some(("common", "union-the-selected-coincident-geometry-is-ambiguous")),
        "UNION: the selected geometry includes an unsupported surface intersection." => Some(("common", "union-the-selected-geometry-includes-an-unsupported-surface-intersection")),
        "UNION: the selected topology could not be closed safely." => Some(("common", "union-the-selected-topology-could-not-be-closed-safely")),
        "Use a previous extraction as a template" => Some(("common", "use-a-previous-extraction-as-a-template")),
        "Use source formatting" => Some(("common", "use-source-formatting")),
        "Used by" => Some(("common", "used-by")),
        "V isolines" => Some(("common", "v-isolines-2")),
        "Value must be nonzero." => Some(("common", "value-must-be-nonzero")),
        "Viewing Direction" => Some(("common", "viewing-direction")),
        "WIPEOUT  Specify next point or [Close/Undo]:" => Some(("common", "wipeout-specify-next-point-or-close-undo")),
        "WIPEOUT  Specify next point or [Undo]:" => Some(("common", "wipeout-specify-next-point-or-undo")),
        "WIPEOUT  Specify next point:" => Some(("common", "wipeout-specify-next-point")),
        "Wireframe type" => Some(("common", "wireframe-type")),
        "XATTACH" => Some(("insert", "xattach")),
        "XATTACH  Specify rotation angle <0>:" => Some(("insert", "xattach-specify-rotation-angle-0")),
        "XATTACH  Specify scale factor <1.0> (X,Y,Z or pick Corner):" => Some(("insert", "xattach-specify-scale-factor-1-0-x-y-z-or-pick-corner")),
        "XOPEN: opening \"{}\"." => Some(("insert", "xopen-opening")),
        "XREF: {e}" => Some(("insert", "xref")),
        "_mtp Specify first point of mid:" => Some(("common", "mtp-specify-first-point-of-mid")),
        "_mtp Specify second point of mid:" => Some(("common", "mtp-specify-second-point-of-mid")),
        "formula" => Some(("common", "formula-2")),
        "name" => Some(("common", "name")),
        "{command}: aligned {} object(s)." => Some(("common", "aligned-object-s")),
        "{}  Select annotative objects:" => Some(("common", "select-annotative-objects")),
        "{} parameter(s) applied." => Some(("common", "parameter-s-applied")),
        "{} row(s) skipped: duplicate parameter name." => Some(("common", "row-s-skipped-duplicate-parameter-name")),
        "{} surface(s) cannot be thickened because the offset intersects itself." => Some(("common", "surface-s-cannot-be-thickened-because-the-offset-intersects-itself")),
        "⚠ {parametric_conflicts} conflicting" => Some(("common", "conflicting")),
        "PLINE  Specify starting width <%{w}>:" => Some(("draw", "pline-specify-starting-width")),
        "PLINE  Specify ending width <%{w}>:" => Some(("draw", "pline-specify-ending-width")),
        "PLINE  Specify starting half-width <%{w}>:" => Some(("draw", "pline-specify-starting-half-width")),
        "PLINE  Specify ending half-width <%{w}>:" => Some(("draw", "pline-specify-ending-half-width")),
        "PLINE (Line)  Specify next point:" => Some(("draw", "pline-line-specify-next-point")),
        "PLINE (Arc)  Specify endpoint of arc:" => Some(("draw", "pline-arc-specify-endpoint-of-arc")),
        "PLINE  Specify length of line:" => Some(("draw", "pline-specify-length-of-line")),
        "PLINE  Specify included angle:" => Some(("draw", "pline-specify-included-angle")),
        "PLINE  Specify endpoint of arc:" => Some(("draw", "pline-specify-endpoint-of-arc")),
        "PLINE  Specify center point of arc:" => Some(("draw", "pline-specify-center-point-of-arc")),
        "PLINE  Specify radius of arc:" => Some(("draw", "pline-specify-radius-of-arc")),
        "PLINE  Specify direction of chord for arc:" => Some(("draw", "pline-specify-direction-of-chord-for-arc")),
        "PLINE  Specify length of chord:" => Some(("draw", "pline-specify-length-of-chord")),
        "PLINE  Specify tangent direction for the start point of arc:" => Some(("draw", "pline-specify-tangent-direction-for-the-start-point-of-arc")),
        "PLINE  Specify second point on arc:" => Some(("draw", "pline-specify-second-point-on-arc")),
        "Halfwidth" => Some(("draw", "halfwidth")),
        "CEnter" => Some(("draw", "center-keyword")),
        "CLose" => Some(("draw", "close-keyword")),
        "Second pt" => Some(("draw", "second-pt")),
        "ARea" => Some(("modify", "area-keyword")),
        "Displacement" => Some(("modify", "displacement")),
        "mOde" => Some(("modify", "mode-keyword")),
        "Array" => Some(("modify", "array-keyword")),
        "Use first point as displacement" => Some(("modify", "use-first-point-as-displacement")),
        "OFFSET  Erase source object after offsetting? [Yes/No] <No>:" => Some(("modify", "offset-erase-source-object-after-offsetting")),
        "OFFSET  Enter layer option for offset objects [Current/Source] <Source>:" => Some(("modify", "offset-enter-layer-option-for-offset-objects")),
        "Recent Input" => Some(("ui", "recent-input")),
        "Copy with Base Point" => Some(("ui", "copy-with-base-point")),
        "Undo %{label}" => Some(("ui", "undo-label")),
        "Redo %{label}" => Some(("ui", "redo-label")),
        "Copy Selection" => Some(("ui", "copy-selection")),
        "Isolate" => Some(("ui", "isolate")),
        "Deselect All" => Some(("ui", "deselect-all")),
        "Options..." => Some(("ui", "options-ellipsis")),
        "Base Point" => Some(("ui", "base-point")),
        ...
        "ARC  Specify start point of arc:" => Some(("draw", "arc-specify-start-point-of-arc")),
        "ARC  Specify second point of arc:" => Some(("draw", "arc-specify-second-point-of-arc")),
        "ARC  Specify end point of arc:" => Some(("draw", "arc-specify-end-point-of-arc")),
        "ARC  Specify center point of arc:" => Some(("draw", "arc-specify-center-point-of-arc")),
        "ARC  Specify included angle:" => Some(("draw", "arc-specify-included-angle")),
        "ARC  Specify length of chord:" => Some(("draw", "arc-specify-length-of-chord")),
        "ARC  Specify tangent direction for the start point of arc:" => Some(("draw", "arc-specify-tangent-direction-for-the-start-point-of-arc")),
        "ARC  Specify radius of arc:" => Some(("draw", "arc-specify-radius-of-arc")),
        "chord Length" => Some(("draw", "chord-length")),
        "Snap Overrides" => Some(("ui", "snap-overrides")),
        "Mid Between 2 Points" => Some(("ui", "mid-between-2-points")),
        "Osnap Settings..." => Some(("ui", "osnap-settings")),
        "Snap override: None (next pick only)." => Some(("ui", "snap-override-none-next-pick-only")),
        _ => None,
    }
}
